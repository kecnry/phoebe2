...
def _export_24(filename, plot=False):
    ...
    if LooseVersion(phoebe.__version__) >= LooseVersion("2.5"):
...
if __name__ == '__main__':
    ...
    #     exit()
    # if LooseVersion(phoebe.__version__) >= LooseVersion("2.4.0") and LooseVersion(phoebe.__version__) < LooseVersion("2.5.0"):
